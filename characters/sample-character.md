...
## Equipment
- Quarterstaff
- Arcane focus (crystal pendant)
- Scholar's pack
- Spellbook
- Ink and quill set
- Small knife for cutting pages
...
**Personality:** Talks too fast when excited about a discovery. Absent-mindedly organizes things by category. Always carrying a book.
**Ideals:** Knowledge should be shared, not hoarded. Understanding the world is the first step to protecting it.
**Bonds:** The impossible journal. She reads it every night, looking for new entries that weren't there before.
**Flaws:** Trusts written sources over people. Freezes up in social situations that can't be solved by quoting a reference.
